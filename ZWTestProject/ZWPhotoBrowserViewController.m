...
//                     ];
    NSArray *url = @[@"https://raw.githubusercontent.com/zwgithub/blog_pic/master/animal_city1.jpg",
                     ];

    UIImage *image = [UIImage imageNamed:@"timeline_image_loading@2x.png"];
    [ZWPhotoBrowserController showImageUrls:url showIndex:0 placeholder:image];
}
